...
public class Entity {
	...
	public static void entitkTicks() {
	...
	public static void renderEntities(Player player, Frustum frustum, float distance, float a) {
		for (int i = 0; i < entities.size(); i++) {
			Entity entity = entities.get(i);
			if (frustum.isVisible(entity.aabb) && entity.distanceToSqr(player) < distance)
				entity.render(a);
		}
	}
}
