...
public class Tile {
	...
	public static final Tile stone = new Tile(1, 3, 100, true, false);
	public static final GrassTile grass = new GrassTile(2, 1, 20, true, false);
	public static final SoilTile soil = new SoilTile(3, 2, 20, true, false);
	public static final Tile cobblestone = new Tile(4, 4, 100, true, false);
	public static final Tile bedrock = new Tile(5, 5, 100000, true, false);
	public static final Tile planks = new Tile(6, 6, 70, true, false);
	public static final Tile oak_planks = new Tile(7, 7, 70, true, false);
	public static final TreeTile trunk = new TreeTile(8, 9, 70, true, false);
	public static final LeafTile leaf = new LeafTile(9, 10, 10, true, true);
	public static final EntityTile sand = new EntityTile(10, 11, 15, true, true);
	public static final LiquidTile water = new LiquidTile(11, 12, 13, 15, false, true, LiquidType.Water);
	public static final CalmLiquidTile calmWater = new CalmLiquidTile(12, 12, 13, 15, false, true, LiquidType.Water);
	public static final LiquidTile lava = new LiquidTile(13, 14, 14, 15, false, true, LiquidType.Lava);
	public static final CalmLiquidTile calmLava = new CalmLiquidTile(14, 14, 14, 15, false, true, LiquidType.Lava);
	...
	public void renderTexture(Tesselator t, Level level, int x, int y, int z, int tex) {
		float c1 = 1.0F;
	    float c2 = 0.8F;
	    float c3 = 0.6F;
	    if(shouldRenderFace(level, x - 1, y, z)) {
