...
public class Font {
	...
	public void print(String string, RGBAColor color, int set) {
		print(string, 0, lines * 15, color, set, 1.0F);
	}
	
	public void printIn(String string, RGBAColor color, int set) {
		print(string, color, set);
		lines++;
	}
