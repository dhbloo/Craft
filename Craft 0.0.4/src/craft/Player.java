...
public class Player extends Entity{
	...
	public static final float PLAYER_JUMP_HEIGHT = 0.17F;		//玩家跳跃高度
	public static final float PLAYER_WALK_SPEED = 0.03F;		//玩家移动速度
	...
	public void tick() {
		...
		if(mode == PlayerMode.Normal) {
			...
			moveRelative(xa, za, onGround ? PLAYER_WALK_SPEED : PLAYER_WALK_SPEED * 0.4F);
