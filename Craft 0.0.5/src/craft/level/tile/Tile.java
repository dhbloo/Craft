...
public class Tile {
	...
	public static final Tile air = new Tile(0, 0, 0);
	public static final Tile stone = new Tile(1, 4, 100);
	public static final Tile grass = new GrassTile(2, 2, 20);
	public static final Tile soil = new SoilTile(3, 3, 20);
	public static final Tile cobblestone = new Tile(4, 5, 100);
	public static final Tile bedrock = new Tile(5, 6, 100000);
	public static final Tile planks = new Tile(6, 7, 50);
	public static final Tile oak_planks = new Tile(7, 10, 50);
	public static final Tile trunk = new TreeTile(8, 9, 50);
	public static final Tile leaf = new LeafTile(9, 11, 15);
	public static final Tile sand = new SandTile(10, 12, 10);
	...
	protected Tile(int id, int tex, int destroyTime) {
		this.tex=tex;
		this.id=id;
	...
	public void render(Level level, int x, int y, int z) {
	    ...
	    if(shouldRenderFace(level, x - 1, y, z)) {
	    	b =  getBrightness(level, x - 1, y, z);
	    	GL11.glColor4f(c2 * b, c2 * b, c2 * b, 1.0F);
	    ...
	    if(shouldRenderFace(level, x, y - 1, z)) {
	    	b =  getBrightness(level, x, y - 1, z);
	    	GL11.glColor4f(c3 * b, c3 * b, c3 * b, 1.0F);
	    	renderFace(x, y, z, Face.Bottom);
	    }
	    if(shouldRenderFace(level, x, y + 1, z)) {
	    	b =  getBrightness(level, x, y + 1, z);
	    	GL11.glColor4f(c1 * b, c1 * b, c1 * b, 1.0F);
	    	renderFace(x, y, z, Face.Top);
	    }
	    if(shouldRenderFace(level, x, y, z - 1)) {
	    	b =  getBrightness(level, x, y, z - 1);
	    	GL11.glColor4f(c2 * b, c2 * b, c2 * b, 1.0F);
	...
	public void renderCrack(Level level) {
		...
		Texture.bind(13 + (int)(10 * (time - 1) / destroyTime));
		float c1 = 1.0F;
	    float c2 = 1.0F;
	    float c3 = 1.0F;
	    float a = 0.8F;
