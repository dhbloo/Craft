package craft_0_0_3.particle;

import org.lwjgl.opengl.GL11;

import craft_0_0_3.Entity;
import craft_0_0_3.level.Level;
import craft_0_0_3.renderer.Texture;

public class Particle extends Entity{
	public static final float PARTICLE_GRAVITY = 0.005F;		//粒子掉落速度 重力值，越大，引力越大
	public static final float PARTICLE_SPEED_DECAY = 0.98F;		//速度衰减 惯性值：(0~1)越小衰减越快
	public static final float PARTICLE_ONGROUND_SPEED_DECAY = 0.7F;		//着地速度衰减 惯性值：(0~1)越小衰减越快
	public static final float PARTICLE_SPEED = 0.15F;			//粒子分散速度
	public static final float PARTICLE_DISPERSED = 0.2F;		//粒子分散程度
	public static final float PARTICLE_LIFE = 10.0F;		//粒子生命
	private int tex;
	private float u0, v0;
	private int age = 0;
