...
import craft.level.tile.TallGrass;
...
public class Level {
	...
	public boolean isIrregularBlock(int x, int y, int z) {
		return Tile.tiles[getBlock(x, y, z)] instanceof TallGrass;
	}
	...
	/**删除指定坐标的实体方块*/
	public boolean deleteTileEntity(int x, int y, int z) {
		return tileEntityList.remove(x, y, z);
	}
